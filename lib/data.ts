...
export const KNOWLEDGE_RECORDS: KnowledgeRecord[] = [
  ...
  {
    id: "CD-INST-JLU-FIRST",
    category: "institution",
    title: "吉林大学第一医院眼科与贾卉教授团队",
    title_en: "Jilin University First Hospital ophthalmology and Professor Jia Hui's team",
    summary:
      "吉林大学第一医院眼科官网将角膜病及角膜移植列入诊疗范围，并描述其为复杂眼科疾病区域转诊中心。医院官网贾卉教授页面显示其长期从事角膜病、眼表疾病及各类角膜移植相关临床工作，是东北地区值得重点记录的角膜病节点。",
    summary_en:
      "The official Jilin University First Hospital ophthalmology page lists corneal disease and corneal transplantation in its clinical scope. The hospital profile for Professor Jia Hui describes long-running work in corneal disease, ocular surface disease, and corneal transplantation, making this an important Northeast China care node to track.",
    key_points: [
      "用户本人角膜移植手术在吉林大学第一医院完成，因此该节点对本站有直接个人记录意义。",
      "医院眼科官网写明诊疗范围覆盖角膜病及角膜移植。",
      "贾卉教授官网资料显示其为眼科中心主任、教授、主任医师、硕士研究生导师，并担任吉林省医学会角膜病及眼表疾病学组组长等职务。",
      "本站仅整理公开信息和个人病史线索，不替代挂号建议；具体出诊、团队成员和术式仍需以医院官方渠道为准。",
    ],
    key_points_en: [
      "The site owner had corneal transplantation at Jilin University First Hospital, so this node has direct personal-record relevance.",
      "The official department page includes corneal disease and corneal transplantation in its clinical scope.",
      "The official profile describes Professor Jia Hui as an ophthalmology center director, professor, chief physician, master's supervisor, and leader in Jilin corneal and ocular surface disease work.",
      "This site organizes public information and personal history context only. Appointments, team members, and surgical choices must be confirmed through official hospital channels.",
    ],
    clinical_use: [
      "东北地区患者或家族成员需要角膜病、角膜移植复诊和二次意见时，可把该院作为重点候选节点之一。",
      "个人记录中可单独追踪在该院完成的手术、复查、验光、角膜地形图、眼压和植片状态。",
    ],
    limits: [
      "官网资料不能替代实时出诊表和医生当面评估。",
      "“知名”表述在本站按公开资料和用户亲历作为候选节点记录，不做医院排名。",
    ],
    tags: ["吉林大学第一医院", "贾卉", "东北", "角膜移植", "角膜病"],
    tags_en: ["Jilin University First Hospital", "Jia Hui", "Northeast China", "corneal transplant", "corneal disease"],
    source_ids: ["SRC-JLU-FIRST-OPHTHALMOLOGY", "SRC-JLU-FIRST-JIA-HUI"],
    evidence_level: "A",
    source_type: "hospital_official",
    source_status: "verified",
    verified_at: "2026-05-15",
...
export const INSTITUTIONS: InstitutionRecord[] = [
  {
    id: "INST-ZOC",
    name: "中山大学中山眼科中心角膜病科",
    name_en: "Zhongshan Ophthalmic Center Cornea Department",
    city: "广州",
    city_en: "Guangzhou",
    country: "中国",
    country_en: "China",
    focus: ["复杂角膜病", "角膜移植", "角膜内皮移植", "眼表重建"],
    focus_en: ["complex corneal disease", "corneal transplant", "endothelial keratoplasty", "ocular surface reconstruction"],
    why_it_matters: "国内角膜病和眼表疾病重要中心，公开资料显示手术类型覆盖全面。",
    why_it_matters_en: "A major Chinese cornea and ocular surface center; public materials show broad coverage of corneal surgery types.",
    public_note: "适合疑难角膜病、复杂眼表和二次意见咨询。",
    public_note_en: "Relevant for complex corneal disease, ocular surface reconstruction, and second-opinion orientation.",
    source_ids: ["SRC-ZOC-CORNEA"],
    evidence_level: "A",
    verified_at: "2026-05-15",
  },
  {
    id: "INST-FUDAN",
    name: "复旦大学附属眼耳鼻喉科医院",
    name_en: "Eye and ENT Hospital of Fudan University",
    city: "上海",
    city_en: "Shanghai",
    country: "中国",
    country_en: "China",
    focus: ["PTK", "TGFBI", "基因编辑研究", "复杂角膜病"],
    focus_en: ["PTK", "TGFBI", "genome-editing research", "complex corneal disease"],
    why_it_matters: "2025 年公开报道 TGFBI 角膜营养不良 PTK 联合基因编辑药物首例患者。",
    why_it_matters_en: "Publicly reported a 2025 first-patient case combining PTK with a genome-editing investigational therapy for TGFBI corneal dystrophy.",
    public_note: "适合跟踪前沿研究，但治疗决策需严格区分临床研究与常规治疗。",
    public_note_en: "Important for research tracking, while treatment decisions must separate clinical research from routine care.",
    source_ids: ["SRC-FUDAN-GEB101-2025"],
    evidence_level: "B",
    verified_at: "2026-05-15",
  },
  {
    id: "INST-TONGREN",
    name: "北京同仁医院眼角膜科",
    name_en: "Beijing Tongren Hospital Cornea Service",
    city: "北京",
    city_en: "Beijing",
    country: "中国",
    country_en: "China",
    focus: ["角膜眼表", "角膜移植", "感染性角膜病", "免疫性角膜病"],
    focus_en: ["cornea and ocular surface", "corneal transplant", "infectious keratitis", "immune corneal disease"],
    why_it_matters: "北京地区传统眼科强中心之一，角膜科公开资料显示覆盖角膜和眼表疾病。",
    why_it_matters_en: "A long-established ophthalmology center in Beijing; public cornea service materials cover corneal and ocular surface diseases.",
    public_note: "自动核验受限，具体医生和出诊需医院官方渠道二次确认。",
    public_note_en: "Automated verification is limited; clinicians and schedules should be confirmed through official hospital channels.",
    source_ids: ["SRC-TONGREN-CORNEA"],
    evidence_level: "B",
    verified_at: "2026-05-15",
  },
  {
    ...
    name_en: "Wenzhou Eye Hospital Cornea and Ocular Surface Center",
    city: "温州",
    city_en: "Wenzhou",
    country: "中国",
    country_en: "China",
    focus: ["深板层角膜移植", "内皮移植", "眼表疾病", "培训基地"],
    focus_en: ["DALK", "endothelial keratoplasty", "ocular surface disease", "training base"],
    why_it_matters: "官网强调角膜移植系统创新、国家级培训基地和陈蔚团队。",
    why_it_matters_en: "The official site emphasizes corneal transplantation innovation, a national training base, and Chen Wei's team.",
    public_note: "适合关注 DALK、内皮移植和复杂眼表疾病。",
    public_note_en: "Relevant for DALK, endothelial keratoplasty, and complex ocular surface disease.",
    source_ids: ["SRC-WZEYE-CORNEA"],
    evidence_level: "A",
    verified_at: "2026-05-15",
  },
  {
    ...
    name_en: "Qingdao Eye Hospital and Shandong Eye Institute",
    city: "青岛",
    city_en: "Qingdao",
    country: "中国",
    country_en: "China",
    focus: ["角膜病", "复杂角膜移植", "眼库", "眼表疾病"],
    focus_en: ["corneal disease", "complex corneal transplant", "eye bank", "ocular surface disease"],
    why_it_matters: "谢立信教授及山东眼科体系是国内角膜病领域重要资源。",
    why_it_matters_en: "Professor Xie Lixin and the Shandong ophthalmology system are important Chinese corneal disease resources.",
    public_note: "适合复杂角膜病和角膜移植相关二次意见咨询。",
    public_note_en: "Relevant for complex corneal disease and corneal-transplant second-opinion orientation.",
    source_ids: ["SRC-SDEYE-XIELIXIN"],
    evidence_level: "A",
    verified_at: "2026-05-15",
  },
  {
    id: "INST-PKU3",
    name: "北京大学第三医院眼科",
    name_en: "Peking University Third Hospital Ophthalmology",
    city: "北京",
    city_en: "Beijing",
    country: "中国",
    country_en: "China",
    focus: ["角膜内皮", "内皮移植", "儿童角膜移植", "组织工程研究"],
    focus_en: ["corneal endothelium", "endothelial keratoplasty", "pediatric corneal transplant", "tissue-engineering research"],
    why_it_matters: "洪晶/彭荣梅团队公开报道角膜内皮替代物和内皮屏障机制研究。",
    why_it_matters_en: "Public research news from Hong Jing / Peng Rongmei's team covers corneal endothelial substitutes and endothelial barrier mechanisms.",
    public_note: "适合关注内皮型疾病与前沿治疗方向。",
    public_note_en: "Relevant for endothelial disease and frontier treatment directions.",
    source_ids: ["SRC-PKU-ENDOTHELIAL-SUBSTITUTE"],
    evidence_level: "B",
    verified_at: "2026-05-15",
  },
  {
    id: "INST-JLU-FIRST",
    name: "吉林大学第一医院眼科",
    name_en: "Jilin University First Hospital Ophthalmology",
    city: "长春",
    city_en: "Changchun",
    country: "中国",
    country_en: "China",
    focus: ["角膜病", "角膜移植", "眼表疾病", "东北地区节点"],
    focus_en: ["corneal disease", "corneal transplant", "ocular surface", "Northeast China"],
    why_it_matters:
      "官网资料显示其眼科诊疗范围包括角膜病及角膜移植；贾卉教授官方资料显示其长期从事角膜病、眼表疾病和各类角膜移植相关临床工作。",
    why_it_matters_en:
      "The official department page includes corneal disease and corneal transplantation in its scope; the official profile for Professor Jia Hui describes long-running clinical work in corneal disease, ocular surface disease, and corneal transplantation.",
    public_note:
      "本站作者本人角膜移植手术在此完成。作为公开索引记录其团队价值，但不做排名或挂号建议，出诊和治疗方案需以医院官方渠道为准。",
    public_note_en:
      "The site owner had corneal transplantation here. This index records the team as a relevant care node, not as a ranking or appointment recommendation; schedules and treatment plans must be confirmed through official hospital channels.",
    source_ids: ["SRC-JLU-FIRST-OPHTHALMOLOGY", "SRC-JLU-FIRST-JIA-HUI"],
    evidence_level: "A",
    verified_at: "2026-05-15",
  },
